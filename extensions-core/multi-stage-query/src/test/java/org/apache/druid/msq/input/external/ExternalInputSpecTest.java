...
public class ExternalInputSpecTest
{
  @Test
  public void testSerde() throws Exception
  {
    ...
    final ExternalInputSpec spec = new ExternalInputSpec(
  ...
  {
    EqualsVerifier.forClass(ExternalInputSpec.class).usingGetClass().verify();
  }
}
