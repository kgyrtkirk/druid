...
public class SketchModule implements DruidModule
{
  ...
  public static final ColumnType BUILD_TYPE = ColumnType.ofComplex(THETA_SKETCH);
  public static final ColumnType MERGE_TYPE = ColumnType.ofComplex(THETA_SKETCH);
