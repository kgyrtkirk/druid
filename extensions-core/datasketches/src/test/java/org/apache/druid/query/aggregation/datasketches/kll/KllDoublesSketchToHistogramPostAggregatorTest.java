...
public class KllDoublesSketchToHistogramPostAggregatorTest
{
  ...
  {
    final PostAggregator there = new KllDoublesSketchToHistogramPostAggregator(
        "post",
  ...
  {
    EqualsVerifier.forClass(KllDoublesSketchToHistogramPostAggregator.class)
  ...
  public void testResultArraySignature()
  {
    final TimeseriesQuery query =
        Druids.newTimeseriesQueryBuilder()
              ...
              .postAggregators(
                  new KllDoublesSketchToHistogramPostAggregator(
                      "a",
                      new FieldAccessPostAggregator("field", "sketch"),
                      new double[] {3.5},
                      null
