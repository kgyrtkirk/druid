...
public class KllDoublesSketchToQuantilePostAggregatorTest
{
  ...
  {
    final PostAggregator there = new KllDoublesSketchToQuantilePostAggregator(
        "post",
  ...
  {
    final PostAggregator postAgg = new KllDoublesSketchToQuantilePostAggregator(
        "post",
        new FieldAccessPostAggregator("field1", "sketch"),
        0.5
    );
  ...
  {
    EqualsVerifier.forClass(KllDoublesSketchToQuantilePostAggregator.class)
