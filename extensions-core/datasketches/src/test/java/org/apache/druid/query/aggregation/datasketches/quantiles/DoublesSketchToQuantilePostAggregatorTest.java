...
public class DoublesSketchToQuantilePostAggregatorTest
{
  ...
  {
    final PostAggregator there = new DoublesSketchToQuantilePostAggregator(
        "post",
  ...
  {
    final PostAggregator postAgg = new DoublesSketchToQuantilePostAggregator(
        "post",
        new FieldAccessPostAggregator("field1", "sketch"),
        0.5
    );
  ...
  {
    EqualsVerifier.forClass(DoublesSketchToQuantilePostAggregator.class)
