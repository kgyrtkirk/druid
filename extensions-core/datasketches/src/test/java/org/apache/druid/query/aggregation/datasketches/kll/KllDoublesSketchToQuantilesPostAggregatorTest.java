...
public class KllDoublesSketchToQuantilesPostAggregatorTest
{
  ...
  {
    final PostAggregator there = new KllDoublesSketchToQuantilesPostAggregator(
        "post",
  ...
  {
    EqualsVerifier.forClass(KllDoublesSketchToQuantilesPostAggregator.class)
  ...
  public void testResultArraySignature()
  {
    final TimeseriesQuery query =
        Druids.newTimeseriesQueryBuilder()
              ...
              .postAggregators(
                  new KllDoublesSketchToQuantilesPostAggregator(
                      "a",
                      new FieldAccessPostAggregator("field", "sketch"),
                      new double[] {0, 0.5, 1}
                  )
