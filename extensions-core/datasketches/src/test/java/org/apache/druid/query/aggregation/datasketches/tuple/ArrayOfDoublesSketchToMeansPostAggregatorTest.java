...
public class ArrayOfDoublesSketchToMeansPostAggregatorTest
{
  ...
  {
    final PostAggregator there = new ArrayOfDoublesSketchToMeansPostAggregator(
        "a",
  ...
  {
    PostAggregator postAgg = new ArrayOfDoublesSketchToMeansPostAggregator(
        "a",
        new ConstantPostAggregator("", 0)
    );
  ...
  {
    EqualsVerifier.forClass(ArrayOfDoublesSketchToMeansPostAggregator.class)
