...
public class DruidUnnest extends Join implements DruidLogicalNode, SourceDescProducer
{
  public DruidUnnest(RelOptCluster cluster,
  ...
  {
    return new DruidUnnest(getCluster(), traitSet, hints, left, right, conditionExpr, variablesSet, joinType);
  }
