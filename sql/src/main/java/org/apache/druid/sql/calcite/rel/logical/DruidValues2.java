 ...
 */
public class DruidValues2 extends LogicalValues implements DruidLogicalNode, InputDescProducer
{
  ...
  {
    return new DruidValues2(getCluster(), traitSet, getRowType(), tuples);
  }
