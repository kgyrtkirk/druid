      ...
      testQuery(
          ...
          ImmutableList.of(
              Druids.newTimeseriesQueryBuilder()
                    ...
                    .intervals(querySegmentSpec(Filtration.eternity()))
                    .granularity(Granularities.ALL)
                    .filters(in("dim2", ImmutableList.of("", "a")))
                    .aggregators(aggregators(new CountAggregatorFactory("a0")))
                    .context(QUERY_CONTEXT_DEFAULT)
                    .build()
          ),
    ...
    testQuery(
        ...
        ImmutableList.of(
            newScanQueryBuilder()
                ...
                .columnTypes(LONG, LONG, LONG, LONG, LONG, LONG, LONG, LONG, LONG)
                .limit(2)
                .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_COMPACTED_LIST)
                .context(QUERY_CONTEXT_DEFAULT)
                .build()
    ...
    testQuery(
        ...
        ImmutableList.of(
            newScanQueryBuilder()
                ...
                .columnTypes(FLOAT, STRING, STRING, STRING, STRING, STRING, STRING, STRING, STRING)
                .filters(equality("dim1", "1", ColumnType.STRING))
                .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_COMPACTED_LIST)
                .limit(1)
                .context(QUERY_CONTEXT_DEFAULT)
      ...
      testQuery(
          ...
          ImmutableList.of(
              Druids.newScanQueryBuilder()
                    ...
                    .intervals(querySegmentSpec(Filtration.eternity()))
                    .columns("v0")
                    .columnTypes(ofComplex("hyperUnique"))
                    .virtualColumns(
                        expressionVirtualColumn(
                            "v0",
