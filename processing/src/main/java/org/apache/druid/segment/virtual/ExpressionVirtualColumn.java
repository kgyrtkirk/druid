...
public class ExpressionVirtualColumn implements VirtualColumn
{
   ...
   * expression string is not known. Instead, it is generated by {@link Expr#stringify()}.
   */
  public ExpressionVirtualColumn(
      final String name,
      final Expr parsedExpression,
  ...
  )
  {
    if (isDirectAccess(columnIndexSelector)) {
      return columnIndexSelector.getIndexSupplier(expression.parsed.get().getBindingIfIdentifier());
    }
