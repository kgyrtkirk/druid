...
public class TimeFormatExtractionFnTest
{
  ...
  public void testSerdeFromJson() throws Exception
  {
    ...
    Assertions.assertEquals(null, extractionFn.getLocale());
    Assertions.assertEquals(null, extractionFn.getTimeZone());
  ...
  public void testCacheKey()
  {
    ...
    Assertions.assertTrue(Arrays.equals(fn2.getCacheKey(), fn3.getCacheKey()));
  }
}
