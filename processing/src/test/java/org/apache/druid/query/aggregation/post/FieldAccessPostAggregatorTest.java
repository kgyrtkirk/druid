...
public class FieldAccessPostAggregatorTest extends InitializedNullHandlingTest
{
  ...
  public void testCompute()
  {
    ...
    Assertions.assertEquals(new Long(0L), fieldAccessPostAggregator.compute(metricValues));

    agg.aggregate();
    agg.aggregate();
    agg.aggregate();
    metricValues.put(aggName, agg.get());
    Assertions.assertEquals(new Long(3L), fieldAccessPostAggregator.compute(metricValues));
  }
