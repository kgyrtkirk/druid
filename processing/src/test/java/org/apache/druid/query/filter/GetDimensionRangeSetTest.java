...
public class GetDimensionRangeSetTest
{
  ...
  public void testSimpleFilter()
  {
    ...
    Assertions.assertEquals(expected1, selector1.getDimensionRangeSet("dim1"));
    Assertions.assertNull(selector1.getDimensionRangeSet("dim2"));

    RangeSet expected2 = rangeSet(point(null));
    Assertions.assertEquals(expected2, selector5.getDimensionRangeSet("dim1"));

    RangeSet expected3 = rangeSet(ImmutableList.of(point("testing"), point("this"), point("filter"), point("tillend")));
    Assertions.assertEquals(expected3, in1.getDimensionRangeSet("dim1"));

    RangeSet expected4 = rangeSet(ImmutableList.of(point("null"), point(null)));
    Assertions.assertEquals(expected4, in3.getDimensionRangeSet("dim1"));

    RangeSet expected5 = ImmutableRangeSet.of(Range.closed("from", "to"));
    Assertions.assertEquals(expected5, bound1.getDimensionRangeSet("dim1"));

    RangeSet expected6 = ImmutableRangeSet.of(Range.atMost("tillend"));
    Assertions.assertEquals(expected6, bound2.getDimensionRangeSet("dim1"));

    RangeSet expected7 = ImmutableRangeSet.of(Range.greaterThan("notincluded"));
    Assertions.assertEquals(expected7, bound3.getDimensionRangeSet("dim1"));

    Assertions.assertNull(other1.getDimensionRangeSet("someDim"));
    Assertions.assertNull(other2.getDimensionRangeSet("someOtherDim"));
    Assertions.assertNull(other3.getDimensionRangeSet("dim"));

    Assertions.assertNull(interval1.getDimensionRangeSet(ColumnHolder.TIME_COLUMN_NAME));
    Assertions.assertNull(interval2.getDimensionRangeSet("dim1"));
  }
  ...
  public void testAndFilter()
  {
    ...
    Assertions.assertEquals(EMPTY, and1.getDimensionRangeSet("dim1"));
    Assertions.assertNull(and1.getDimensionRangeSet("dim2"));
    ...
    Assertions.assertEquals(expected2, and2.getDimensionRangeSet("dim1"));
    ...
    Assertions.assertEquals(expected3, and3.getDimensionRangeSet("dim1"));
    Assertions.assertEquals(EMPTY, and3.getDimensionRangeSet("dim2"));

    DimFilter and4 = new AndDimFilter(ImmutableList.of(in3, bound3));
    RangeSet expected4 = rangeSet(point("null"));
    Assertions.assertEquals(expected4, and4.getDimensionRangeSet("dim1"));
    ...
    Assertions.assertEquals(expected5, and5.getDimensionRangeSet("dim1"));
  }
  ...
  public void testOrFilter()
  {
    ...
    Assertions.assertEquals(expected1, or1.getDimensionRangeSet("dim1"));
    ...
    Assertions.assertEquals(expected2, or2.getDimensionRangeSet("dim1"));

    DimFilter or3 = new OrDimFilter(ImmutableList.of(bound1, bound2, bound3));
    Assertions.assertEquals(ALL, or3.getDimensionRangeSet("dim1"));

    DimFilter or4 = new OrDimFilter(ImmutableList.of(selector1, selector2, selector3, selector4, selector5));
    Assertions.assertNull(or4.getDimensionRangeSet("dim1"));
    Assertions.assertNull(or4.getDimensionRangeSet("dim2"));
    ...
    Assertions.assertEquals(expected5, or5.getDimensionRangeSet("dim1"));
  }
  ...
  public void testNotFilter()
  {
    ...
    Assertions.assertEquals(expected1, not1.getDimensionRangeSet("dim1"));
    Assertions.assertNull(not1.getDimensionRangeSet("dim2"));
    ...
    if (NullHandling.sqlCompatible()) {
      ...
      Assertions.assertEquals(expected2, not2.getDimensionRangeSet("dim1"));
    } else {
      RangeSet expected2 = rangeSet(ImmutableList.of(
          Range.lessThan(""),
          Range.open("", "null"),
    ...
    Assertions.assertEquals(expected3, not3.getDimensionRangeSet("dim1"));

    DimFilter not4 = new NotDimFilter(not2);
    RangeSet expected4 = rangeSet(ImmutableList.of(point(null), point("null")));
    Assertions.assertEquals(expected4, not4.getDimensionRangeSet("dim1"));
    ...
    Assertions.assertEquals(expected5, not5.getDimensionRangeSet("dim1"));
    Assertions.assertNull(not5.getDimensionRangeSet("dim2"));
    ...
    Assertions.assertEquals(expected6a, not6.getDimensionRangeSet("dim1"));
    Assertions.assertEquals(expected6b, not6.getDimensionRangeSet("dim2"));
    ...
    Assertions.assertEquals(expected7, not7.getDimensionRangeSet("dim1"));
    Assertions.assertNull(not7.getDimensionRangeSet("dim2"));

    DimFilter and2 = new AndDimFilter(ImmutableList.of(bound1, bound2, bound3, bound4));
    DimFilter not8 = new NotDimFilter(and2);
    Assertions.assertNull(not8.getDimensionRangeSet("dim1"));
    Assertions.assertNull(not8.getDimensionRangeSet("dim2"));
