...
public class LongFirstAggregationTest extends InitializedNullHandlingTest
{
  ...
  public void testLongFirstAggregator()
  {
    ...
    Assertions.assertEquals(longValues[3], result.rhs.longValue());
    Assertions.assertEquals(longValues[3], agg.getLong());
    Assertions.assertEquals(longValues[3], agg.getFloat(), 0.0001);
  }
  ...
  public void testLongFirstAggregatorWithTimeColumn()
  {
    ...
    Assertions.assertEquals(longValues[1], agg.getFloat(), 0.0001);
  }
  ...
  public void testLongFirstBufferAggregator()
  {
    ...
    Assertions.assertEquals(longValues[1], agg.getFloat(buffer, 0), 0.0001);
  }
  ...
  public void testLongFirstBufferAggregatorWithTimeColumn()
  {
    ...
    Assertions.assertEquals(times[3], result.lhs.longValue());
    Assertions.assertEquals(longValues[3], result.rhs.longValue());
    Assertions.assertEquals(longValues[3], agg.getLong(buffer, 0));
    Assertions.assertEquals(longValues[3], agg.getFloat(buffer, 0), 0.0001);
  }
  ...
  public void testCombine()
  {
    ...
    Assertions.assertEquals(pair1, longFirstAggFactory.combine(pair1, pair2));
  }
  ...
  public void testSerde() throws Exception
  {
    ...
    Assertions.assertEquals(longFirstAggFactory, deserialized);
    Assertions.assertArrayEquals(longFirstAggFactory.getCacheKey(), deserialized.getCacheKey());
  }
  ...
  public void testLongFirstAggregeCombiner()
  {
    ...
    Assertions.assertEquals(pairs[0], longFirstAggregateCombiner.getObject());
    ...
    longFirstAggregateCombiner.reset(columnSelector);
    Assertions.assertEquals(pairs[2], longFirstAggregateCombiner.getObject());
  }
