...
public class ConfigManagerTest
{
  ...
  public void testSetNewObjectIsNull()
  {
    ...
    Assertions.assertTrue(setResult.getException() instanceof IllegalAccessException);
  }
  ...
  public void testSetConfigManagerNotStarted()
  {
    ...
    Assertions.assertFalse(setResult.isOk());
    Assertions.assertFalse(setResult.isRetryable());
    Assertions.assertTrue(setResult.getException() instanceof IllegalStateException);
  }
