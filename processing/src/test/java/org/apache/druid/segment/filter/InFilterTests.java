...
public class InFilterTests
{
  ...
  public static class InFilterTest3 extends BaseFilterTest
  {
    ...
    {
      BaseFilterTest.tearDown(InFilterTest2.class.getName());
    }
    ...
    public void testMatchWithLookupExtractionFn()
    {
      ...
      if (optimize) {
        // Arrays don't cause errors when the extractionFn is optimized, because
        // the "IN" filter vanishes completely.
  ...
  @RunWith(Parameterized.class)
  public static class InFilterTest2 extends BaseFilterTest
  {
    private static final List<InputRow> ROWS = ImmutableList.of(
        makeDefaultSchemaRow("a", "", ImmutableList.of("a", "b"), "2017-07-25", "", 0.0, 0.0f, 0L),
        makeDefaultSchemaRow("b", "10", ImmutableList.of(), "2017-07-25", "a", 10.1, 10.1f, 100L),
