...
public class NestedPathFinderTest
{
  ...
  public void testParseJqPath()
  {
    ...
    Assertions.assertTrue(pathParts.get(0) instanceof NestedPathField);
    ...
    Assertions.assertTrue(pathParts.get(1) instanceof NestedPathArrayElement);
    ...
    Assertions.assertTrue(pathParts.get(0) instanceof NestedPathField);
    Assertions.assertEquals("x", pathParts.get(0).getPartIdentifier());
    Assertions.assertTrue(pathParts.get(1) instanceof NestedPathField);
    Assertions.assertEquals("1", pathParts.get(1).getPartIdentifier());
    Assertions.assertEquals(".\"x\".\"1\"", NestedPathFinder.toNormalizedJqPath(pathParts));
    ...
    Assertions.assertTrue(pathParts.get(1) instanceof NestedPathArrayElement);
    Assertions.assertEquals("1", pathParts.get(1).getPartIdentifier());
    Assertions.assertTrue(pathParts.get(2) instanceof NestedPathField);
    Assertions.assertEquals("foo", pathParts.get(2).getPartIdentifier());
    Assertions.assertTrue(pathParts.get(3) instanceof NestedPathField);
