...
public class FileWriteOutBytesTest
{
  ...
  public void testIOExceptionHasFileInfo() throws Exception
  {
    ...
    Assertions.assertEquals(actual.getCause(), cause, String.valueOf(actual.getCause()));
    Assertions.assertEquals(actual.getMessage(), "Failed to write to file: /tmp/file. Current size of file: 34", actual.getMessage());
  }
}
